...
class MultipleChoiceQuestion(Question):
    ...
    === Private Attributes ===
    _options: the possible answers of the question
...
class NumericQuestion(Question):
    ...
    === Private Attributes ===
    _max_: the maximum integer of the question
    _min_: the minimum integer of the question
    ...
    def get_similarity(self, answer1: Answer, answer2: Answer) -> float:
        ...
        value = abs_diff / (self._max_ - self._min_)
...
class CheckboxQuestion(MultipleChoiceQuestion):
    ...
    def get_similarity(self, answer1: Answer, answer2: Answer) -> float:
        ...
        """
        intersection = len(
            set(answer1.content).intersection(set(answer2.content)))
        union = len(set(answer1.content).union(set(answer2.content)))
...
class Survey:
    ...
    def __init__(self, questions: list[Question]) -> None:
        ...
        self._weights = dict.fromkeys(self._questions.keys(), 1)
    ...
    def score_students(self, students: list[Student]) -> float:
        ...
        try:
            ...
            for question in self.get_questions():
                ...
                quality_score = self._get_criterion(
                    question).score_answers(question, answers)
